...
#             if cube_color == 'red' and cube_num > 12:
#                 red_possible = False
#             elif cube_color == 'green' and cube_num > 13:
#                 green_possible = False
#             elif cube_color == 'blue' and cube_num > 14:    
#                 blue_possible = False
...
def readLine(line):
    ...
    for cube_set in cube_sets:
        ...
        for cube in cubes:
            ...
            cube_num = int(cube.split(' ')[0])
            if cube_color == 'red':
                if red_max == None or cube_num > red_max:
                    red_max = cube_num
            elif cube_color == 'green':
                if green_max == None or cube_num > green_max:
                    green_max = cube_num
            elif cube_color == 'blue':
                if blue_max == None or cube_num > blue_max:
                    blue_max = cube_num
